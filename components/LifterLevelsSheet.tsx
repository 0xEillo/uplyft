              ...
              return (
                <View key={level} style={styles.cardContainer}>
                  <View style={[styles.card, locked && styles.cardLocked]}>
                    {/* Level Badge */}
                    <View style={[styles.levelBadge, { backgroundColor: locked ? '#333' : color }]}>
                    ...
                    <View style={styles.cardFooter}>
                      <Text style={[styles.levelName, locked && styles.textLocked]}>
                        {level.toUpperCase()}
                      </Text>
                      ...
                      {isCurrent ? (
                        <View style={styles.statusContainer}>
                          {level !== 'World Class' && (
                             <Text style={styles.progressText}>{Math.round(progressToNext)}% to next level</Text>
                          )}
                        </View>
                      ) : locked ? (
