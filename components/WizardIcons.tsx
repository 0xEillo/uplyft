...
interface WizardIconProps {
  name: 'goal' | 'muscles' | 'duration' | 'equipment' | 'notes';
  size?: number;
  color?: string;
}

export function WizardIcon({ name, size = 24, color = '#FF5722' }: WizardIconProps) {
  ...
  switch (name) {
    ...
    case 'muscles':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          <Circle cx="12" cy="4" r="2.5" stroke={color} strokeWidth={strokeWidth} />
          <Path
            ...
            strokeLinejoin="round"
          />
          {/* Subtle chest/muscle definition line */}
          <Path
    ...
    case 'duration':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          ...
          <Path d="M10 2H14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
        </Svg>
      );
    case 'notes':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          ...
          <Path d="M8 8H16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
          <Path d="M8 12H16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
          <Path d="M8 16H12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
        </Svg>
      );
    default:
      return null;
