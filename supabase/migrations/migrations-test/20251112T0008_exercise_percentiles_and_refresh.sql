-- Percentile analytics pipeline for 1RM tracking

-- Recreate materialized view with gender/weight buckets and helper RPCs
...
-- Lock down direct table access and add caller authorization
...
-- Refresh materialized view whenever workouts change
...
-- Harden percentile helpers with safe defaults
...
-- Refresh view when user weight changes
...
-- Target weight helper for percentile goals
