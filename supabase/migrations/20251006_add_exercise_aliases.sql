...
-- Chest exercises
UPDATE exercises SET aliases = ARRAY['bench press', 'bench', 'flat bench'] WHERE name = 'Bench Press';
...
-- Back exercises
UPDATE exercises SET aliases = ARRAY['deadlift', 'conventional deadlift', 'dead lift'] WHERE name = 'Deadlift';
UPDATE exercises SET aliases = ARRAY['barbell row', 'bb row', 'row', 'bent row'] WHERE name = 'Bent Over Row';
UPDATE exercises SET aliases = ARRAY['pullup', 'pull up', 'pullups', 'chin up', 'chinup'] WHERE name = 'Pull-ups';
...
-- Legs exercises
UPDATE exercises SET aliases = ARRAY['squat', 'back squat', 'barbell squat'] WHERE name = 'Squat';
...
UPDATE exercises SET aliases = ARRAY['calf raises', 'calves'] WHERE name = 'Calf Raise';
UPDATE exercises SET aliases = ARRAY['lunge', 'walking lunges'] WHERE name = 'Lunges';

-- Shoulders exercises
UPDATE exercises SET aliases = ARRAY['ohp', 'overhead press', 'military press', 'press', 'shoulder press'] WHERE name = 'Overhead Press';
...
UPDATE exercises SET aliases = ARRAY['bicep curl', 'curl', 'curls', 'arm curl'] WHERE name = 'Dumbbell Curl';
UPDATE exercises SET aliases = ARRAY['bb curl', 'barbell curls'] WHERE name = 'Barbell Curl';
UPDATE exercises SET aliases = ARRAY['hammer curls'] WHERE name = 'Hammer Curl';

-- Arms exercises (Triceps)
UPDATE exercises SET aliases = ARRAY['tricep dips', 'dips', 'dip'] WHERE name = 'Tricep Dip';
UPDATE exercises SET aliases = ARRAY['tricep pushdowns', 'pushdown', 'cable pushdown'] WHERE name = 'Tricep Pushdown';
...
UPDATE exercises SET aliases = ARRAY['hanging leg raises', 'leg raises'] WHERE name = 'Hanging Leg Raise';
UPDATE exercises SET aliases = ARRAY['ab roller', 'ab rollout'] WHERE name = 'Ab Wheel';

-- Glutes exercises
UPDATE exercises SET aliases = ARRAY['hip thrusts', 'barbell hip thrust'] WHERE name = 'Hip Thrust';
UPDATE exercises SET aliases = ARRAY['bulgarian split squats', 'split squat'] WHERE name = 'Bulgarian Split Squat';
UPDATE exercises SET aliases = ARRAY['glute bridges', 'bridge'] WHERE name = 'Glute Bridge';
UPDATE exercises SET aliases = ARRAY['cable kickbacks', 'kickback'] WHERE name = 'Cable Kickback';
